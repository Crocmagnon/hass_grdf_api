...
env = environ.Env(
    DEBUG=(bool, False),
    SECRET_KEY=(str, "sPccIKqWgyHbBLEDeKKpcjfnjwYDvLUueRXuAmbOZnsGlfEMag"),
    ALLOWED_HOSTS=(list, []),
...
ROOT_URLCONF = "hass_grdf_api.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "hass_grdf_api.context_processors.app",
            ],
        },
    },
]

WSGI_APPLICATION = "hass_grdf_api.wsgi.application"
...
DEBUG_TOOLBAR_CONFIG = {
    "SHOW_TOOLBAR_CALLBACK": "hass_grdf_api.middleware.debug_toolbar_bypass_internal_ips",
